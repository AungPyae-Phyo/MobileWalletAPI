...
namespace Application.Services
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(IUserRepo userRepository, TokenService tokenService)
        {
        ...
        public async Task<AuthResponse> LoginUserAsync(UserLoginDto userLoginDto)
        {
            try
            {
                ...
                if (user == null || !BCrypt.Net.BCrypt.Verify(userLoginDto.HashPassword, user.HashPassword))
